...
const Gallery = () => {
  return (
    <>
      ...
      />
      <LogoCarousel title={"Our Trusted Partners"} />
      <div id="photos" style={{ scrollMarginTop: "-100px" }}>
        <Headings
      ...
      <div id="media" style={{ scrollMarginTop: "-100px" }}>
        <Headings
      ...
      <div id="annual-report" style={{ scrollMarginTop: "-100px" }}>
        <Transperancy />
      </div>
